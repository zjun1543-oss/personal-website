      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#sections"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-gray-800 rounded-full text-lg font-medium hover:bg-gray-100 transition-colors shadow-lg"
            >
              开始探索
            </Link>
            <Link
              href="/psychology"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white rounded-full text-lg font-medium hover:bg-white hover:text-gray-800 transition-colors"
            >
              阅读文章
            </Link>
          </div>
